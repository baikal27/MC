...
// 베이스노드 정의
#ifndef __AXT_BASE_NODE__
    #define __AXT_BASE_NODE__
    typedef enum _AXT_BASE_NODE
    {
...
#ifndef WM_AXL_NETSTAT
    #define WM_AXL_NETSTAT                        (WM_USER + 1002)
#endif
...
typedef void (__stdcall *AXT_NETMON_PROC)(long lActiveNo, DWORD uFlag);
