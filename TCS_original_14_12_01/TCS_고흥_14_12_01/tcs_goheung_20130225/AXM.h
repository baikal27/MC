...
//========== 노드 및 모듈 확인함수(Info) - Infomation =================================================================================
    ...
    DWORD    __stdcall AxmInfoGetAxis(long lAxisNo, long *lpNodeNum, long *lpModulePos, DWORD *upModuleID);
    // 모션 모듈이 존재하는지 반환한다.
    ...
    DWORD    __stdcall AxmInfoGetFirstAxisNo(long lNodeNum, long lModulePos, long *lpAxisNo);
...
//====================트리거 함수 ===============================================================================================================================
    ...
    //  주의사항: AxmTriggerSetAbsPeriod의 주기모드로 설정할 경우 처음 그위치가 범위 안에 있으므로 트리거 출력이 한번 발생한다.
...
//========= 부가기능 함수 ============================================================================
    ...
    //                   '1' - 감속 정지
    //                   '2' - 급 정지
    DWORD    __stdcall AxmNetWorkErrorSetAction(long lAxisNo, DWORD dwNetErrorAct);
    // 지정 축이 연결된 노드의 통신이 끊어 졌을때 현재 모션 동작 상태에 대한 예외처리 방법 확인.
    DWORD    __stdcall AxmNetWorkErrorGetAction(long lAxisNo, DWORD* dwpNetErrorAct);
